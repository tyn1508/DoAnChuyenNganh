...
const ListFilm = ({ title, data }) => {
  const { handleTrailer } = useContext(FilmContext)

  return (
    <div className="text-white p-10 mb-10">
      <h2 className="uppercase text-3xl mb-4 font-bold">
        {title}
      </h2>
      <Carousel responsive={responsive} className="flex items-center justify-center space-x-4">
